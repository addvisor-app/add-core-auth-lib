        ...
        if(authorized){
            ...
            if(!code){
                ...
                if(jwt.expires_in){
                    ...
                    expireTime = jwt.expires;
                }
                authClient._log("JWT ", jwt);
                authClient._log("JWT expires_in", jwt.expires_in);
                authClient._log("JWT exp", jwt.exp);
                authClient._log("JWT expires", jwt.expires);
                authClient._log("JWT expireTime", expireTime);
