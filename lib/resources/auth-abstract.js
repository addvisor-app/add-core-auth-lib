...
module.exports = class AuthAbstract {
    ...
    async getToken(req){
        ...
        console.log('AuthAbstract getToken token', token);
        return token;
    }
    ...
    _getRedirectURL(req){
        ...
        this._log("AuthAbstract _getRedirectURL uri", uri);
        this._log("AuthAbstract _getRedirectURL query", query);
        this._log("AuthAbstract _getRedirectURL host", host);
        this._log("AuthAbstract _getRedirectURL protocol", protocol);
        

        const proxyHost = req.headers["x-forwarded-host"];
        const host2 = proxyHost ? proxyHost : req.headers.host;

        this._log("AuthAbstract _getRedirectURL host2", host2);
    ...
    async _log (...args) {
        //if(this._debug){
            ...
            console.log("[",date, "ADD AUTH LIB]", ...args);
        //}
    }
}